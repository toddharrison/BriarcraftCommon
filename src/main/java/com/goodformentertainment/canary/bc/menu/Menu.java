...
import com.goodformentertainment.canary.bc.menu.hook.MenuCloseHook;
import com.goodformentertainment.canary.bc.menu.hook.MenuItemSelectHook;
import com.goodformentertainment.canary.bc.menu.hook.MenuOpenHook;
        ...
        if (hook.getInventory() == inventory) {
            ...
            if (item != null) {
                ...
                if (menuItem != null && !menuItem.isDisabled()) {
                    Canary.hooks()
                            .callHook(new MenuItemSelectHook(hook.getPlayer(), this, menuItem));
                }
            }
            hook.setCanceled();
        }
