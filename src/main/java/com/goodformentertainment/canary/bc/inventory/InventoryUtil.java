package com.goodformentertainment.canary.bc.inventory;
...
public final class InventoryUtil {
    public static boolean hasItems(final Inventory inv,
            final Map<ItemType, Integer> requiredItems) {
    ...
    public static boolean removeItems(final Inventory inv,
            final Map<ItemType, Integer> requiredItems) {
